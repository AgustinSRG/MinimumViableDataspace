...
public class DcpPatchExtension implements ServiceExtension {
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        trustedIssuerRegistry.register(new Issuer("did:indy:besu:wf:0x9df759c1962a232ae379a499e6fd2a1b5b96e6be", Map.of()), WILDCARD); // for the credential used to demo the issuance flow
